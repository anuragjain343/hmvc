...
<head>
    ...
    <title>MyVeganTrainer | Password Reset</title>
...
<body style="font-family: 'Source Sans Pro', sans-serif; padding:0; margin:0;">
    <table style="max-width: 750px; margin: 0px auto; width: 100% ! important; background: #F3F3F3; padding:30px 30px 30px 30px;" width="100% !important" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td style="text-align: center; background: #5dbbf2;">
                <table width="100%" border="0" cellpadding="30" cellspacing="0">    
                    <tr>
                        <td>
                            <img style="max-width: 125px; width: 100%;padding: 10px;" src="<?php echo base_url().APP_ADMIN_ASSETS_IMG;?>logo.png">
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table width="100%" border="0" cellpadding="30" cellspacing="0" bgcolor="#fff">
                    <tr>
                        <td>
                            ...
                            <p style="text-align: left; color: #333; font-size: 16px; line-height: 28px;"><?php echo $email; ?></p>
                            <p style="text-align: left;color: #333; font-size: 16px; line-height: 28px;">You Recently requested to reset your password for your MyVeganTrainer account. Please use password given below to login: </p>
                            ...
                            <p style="text-align: left;color: #333; font-size: 16px; line-height: 28px;">Thanks,<br>MyVeganTrainer team</p>  
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="text-align: center;">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#fff">
                    <tr>
                        <td style="padding: 10px;background: #5dbbf2;color: #fff;">MyVeganTrainer © 2018-2019</td>
                    </tr>
                </table>
            </td>
        </tr>
