                                    ...
                                    <div class="heading-elements my-1">
                                        <ul class="list-inline d-block mb-0">
                                            <li> <?php $tid = encoding($assignTrainer->id);?>
                                                <a href="<?php echo base_url()?>admin/trainers/trainerDetails/<?php echo $tid ?>" class="btn btn-sm btn-danger danger box-shadow-3 round btn-min-width pull-right" href="#">
