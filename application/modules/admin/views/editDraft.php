                    ...
                    <div class="card">
                        ...
                        <div class="card-content collpase show">
                            <div class="card-body">
                                ...
                                <form class="form" id="addarticle" action="<?php echo base_url()?>admin/article/add_article" method="POST">
                                    <div class="form-body">
                                        <div class="row">        
                                            ...
                                            <div class="form-group col-12 mb-2"> 
                                                ...
                                                <textarea id="description" rows="5" class="form-control round"  placeholder="Description" name="description"  moduleType="article">
                                            ...
                                            <div class="col-12 ">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" id="yes" name="radio" value="<?php if($data->isDisableComment==0){
                                                    echo $data->isDisableComment;
                                                }
                                                    ?>" checked>YES</label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="radio" value="<?php if($data->isDisableComment==1){
                                                    echo $data->isDisableComment;
                                                }
                                                    ?>" id="no" >NO</label>
                                            </div>
...
<script type="text/javascript">
var currentUser = '<?php echo base_url();?>admin/article/addArticle';
...
function push_artical_data(flg){
    ...
    if(title_a.length > 0 || description_a.length > 0){
     formData = {title:title_a,description:description_a,radio:selValue,articleStatus:0,upd_articlearticle:id_a},
