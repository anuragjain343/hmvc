 <?php if(!empty($categoryIdMenu)){
        if($categoryIdMenu == 1){ 
            $header = 'Supplementation & Food';
        }
        else {
         $header = 'Discounts & offers';
         }
    ...
    <div class="app-content content">
          <div class="content-wrapper">        
            <div class="content-wrapper-before Hedtxt">
                ...
                <a class="btn btn-sm btn-danger danger box-shadow-3 round btn-min-width pull-right mr-2" href="<?php echo base_url();?>admin/RecommendedProducts/addRecommendedProducts?catTrainId=<?php echo encoding($catTrainId); ?>">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="text-truncate wdth-fix">
                                                    <a href="<?php echo base_url()?>admin/recommendedProducts/recommendedProducts_detail/<?php echo encoding($value->id);?>">
                                                ...
                                                <td class="text-truncate align-middle media">
                                                   ...
                                                   $userId = encoding($value->addedById);
                                                    ...
                                                    <div class="media-body psted-by-text">
                                                        <h5 class="mt-0"><?php echo time_elapsed_string($value->crd);?> By <a href="<?php echo base_url()?>admin/ecommendedProducts/<?php echo $userId;?>/<?php echo $_SESSION[ADMIN_USER_SESS_KEY]['UserRole'];?>/<?php echo $value->addedBy;?>"><?php echo $value->fullName;?></a></h5>
                                                    </div>
                                                </td>                                                
                                                ...
                                                <?php
                                                    ...
                                                    <a href="<?php echo base_url()?>admin/recommendedProducts/recommendedProducts_detail/<?php echo encoding($value->id);?>"><i class="ft-eye icon-opacity"></i></a>
                                                    <a href="javascript:void(0);" onclick="<?php echo $clickDelete; ?>">
                                                        <i class="ft-trash-2"></i></a>
                                                            <a href="<?php echo base_url()?>admin/recommendedProducts/edit_recommendedProducts?id=<?php echo encoding($value->id);?>" ">
                                                            <i class="ft-edit-2"></i>
                                                        </a>
                                                </td>
                                            </tr>                                
