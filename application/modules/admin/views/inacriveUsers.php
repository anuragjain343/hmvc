...
<div class="content-wrapper">        
  <div class="content-wrapper-before Hedtxt">
      <h2 class="ml-2">Inactive Users(<?php if(!empty($total_user)){ echo $total_user;  }else{ echo '0'; } ?>)</h2>
  </div>
        ...
        <div class="card-content">
          <div class="row p-1 justify-content-end">
            <div class="col-12 col-lg-4 col-md-4 col-sm-6">
              <input type="text" class="form-control round " id="iconLeft4" placeholder="Search">
            </div>
            <div class="col-12 col-lg-4 col-md-4 col-sm-6">
              <div class="rs_mt-10">
                <select class="custom-select round" name="carlist" id="customSelect" onchange="searchByLevel(this.value,'<?php echo get_csrf_token()['hash'];?>');"><?php if(!empty($cat)){ $sel='selected';
                  }else{ $sel='';}?>
                  <option  class=""  id=""       value="" >All Level</option>
          ...
          <div id="recent-projects" class="media-list">
            <div class="table-responsive">
              <table class="table table-padded table-xl mb-0 user-list-tble" id="recent-project-table">
                ...
                <tbody id="rList">
            <!-- <div class="app-content content" id="rList"></div> -->
                </tbody>  
                 </table>    
              </div>
          </div>
