...
<div class="app-content content">
      <div class="content-wrapper">
        ...
        <form class="form mt-20 form" id="add_exercise" action="<?php echo base_url()?>admin/RecommendedProducts/add_PreferredSuppliers">
            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6 mb-2">
                                            <div class="upload-imgs pd-img index-pge-uplod bck-image">
                                                <img class="PrintImg" src="assets/img/index_upload.png" id="preview1" style="display: none;">
                                        ...
                                        <div class="form-group col-6 mb-2">
                                            <div class="upload-imgs pd-img index-pge-uplod bck-image">
                                                <img class="PrintImg" src="/img/slide-image3.png" id="preview2" style="display: none;">
                                        ...
                                        <div class="form-group col-6 mb-2">
                                            <div class="upload-imgs pd-img index-pge-uplod bck-image">
                                                <img class="PrintImg" src="<?php echo base_url() ?>backend_assets/img/index_upload.png" id="preview5" style="display: none;">
