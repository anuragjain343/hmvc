            ...
            <div class="row">
                                ...
                                <?php 
                                    ...
                                    foreach ($image as $k => $val) {
                                        ...
                                        <div class="carousel-item <?php if($k==0){echo 'active';}?>">
                                            <img src="<?php echo base_url(TRAINING_MEDIUM).$val;?>" class="d-block w-100" alt="First slide">
                                        </div>
                            <?php }
                        }
                        ?>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="card blck-sec">
                        <div class="card-body nutrtin-ttle EditSec">
                            ...
                            <div class="EditRight">
                                <ul class="list-inline mb-0">
                                    ...
                                    <li>
                                       <a href="<?php echo base_url()?>admin/training/edit_training?id=<?php echo encoding($trainerId);?>"">
                                            <i class="ft-edit-2"></i>
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <div id="carousel-area" class="carousel slide vedio-slde" data-interval="false">
                            <ol class="carousel-indicators">
                                <?php 
                                    ...
                                    foreach ($video as $k => $val) { ?>
                                        <div class="carousel-item <?php if($k==0){echo 'active';}?>">
                                            <video controls="" class="VideoHeight">
                                                <source src="<?php echo base_url(TRAINING_CATEGORY_VIDEO).$val;?>" type="video/mp4">
                                            </video>
                                        </div>
                                   <?php } 
                                ?>
                       ...
                       $pdf = 'Download PDF';
                        ...
                        <?php if(!empty($trainingData->pdf)){?>
                            <span class="tags float-right">
                                <a class="btn btn-sm btn-danger danger box-shadow-3 round btn-min-width pull-right" href="<?php echo !empty($trainingData->pdf) ? base_url().TC_PDF.$trainingData->pdf : JSV0; ?>"" target="_blank">
