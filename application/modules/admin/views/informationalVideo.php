...
<div class="app-content content">
      <div class="content-wrapper">
        <div class="content-wrapper-before Hedtxt">
            <h2 class="ml-2">Informational Videos (<?php if(!empty($total_video)){echo $total_video; } ?>)</h2>

            <a class="btn btn-sm btn-danger danger box-shadow-3 round btn-min-width pull-right mr-2" href="<?php echo base_url();?>admin/video/addVideo">
...
var  baseurl='<?php echo base_url();?>';
  ...
  // var  url = base_url+'admin/user/loadPagination/0';
    var  url = baseurl+'admin/video/video_List';
    load_page(url);
});
