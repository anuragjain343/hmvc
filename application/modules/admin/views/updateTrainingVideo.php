                ...
                <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="card-content collpase show">
                            <div class="card-body">
                                <form class="form" id="updateTrainingVideos" action="<?php echo base_url();?>admin/video/update_trainingVideo" method="POST">
                                    <div class="form-body">
         ...
         <!--    <option <?php if( strpos($videoData->videoLevelType,'3')!== false){ echo "selected"; } ?> value="3">Level 3</option>
            ...
            <option <?php if( strpos($videoData->videoLevelType,'4') !== false){ echo "selected"; } ?> value="4">Level 4</option> -->
                                             ...
                                             <!--  <fieldset class="form-group col-12 mb-2">
                                                <select class="custom-select round" id="customSelect" name="levelName">
                                            ...
                                            <video style="width: 100%; height: 281px; background-color: rgb(0, 0, 0); border: 1px solid rgba(238, 255, 238, 0.933);display:none;" id="updateVideo" controls=""><source  id="video_here" src="<?php echo base_url().'uploads/trainingVideo/'.$videoData->trainingVideo;?>"></video>
                                                 <?php
                                        if(!empty($videoData->trainingVideo)){?>
                                    ...
                                    <div class="form-actions frm-btns mt-0">
                                        <a href="<?php echo base_url()?>admin/video/trainingVideo" class="btn btn-danger mr-1">
                                            <i class="ft-x"></i> Cancel
                                        </a>
                                
                                          <button type="button" class="btn btn-primary" id="update_traing_Video"><i class="la la-check-square-o"></i>Update
                                          </button>
