 ...
 <?php  if(!empty($userList)){ foreach($userList as $value){  ?>
                  <tr>
                   <td class="text-truncate align-middle">
                    ...
                    <?php }?>
                     <a ><i class="ft-trash-2 clr2" onclick="deletefnUser('<?php echo $value->id ?>','<?php echo get_csrf_token()['hash'];?>')"></i></a>
                      </td>
                  </tr> 
                ...
                <?php } }else{ ?>
                  <tr>
                   <td class="text-truncate align-middle"> No Record Found.
                   </td>
                 </tr>
...
<script type="text/javascript">
   var  baseurl='<?php echo base_url()?>admin/users/inactiveUser_List';
...
var  baseurl='<?php echo base_url();?>';
  if($(this).val().trim().length < 2   && $(this).val()!= ''){
   return false;
    ...
    var  url = baseurl+'admin/users/inactiveUser_List';
    load_page(url);
});
