                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-12 mb-2">
                                            ...
                                            <input type="text" id="banner_title1" class="form-control round" placeholder="Title" name="banner_title1" value="">
                                        </div>
                                        <div class="form-group col-lg-6 col-xs-12 mb-2">
                                            <div class="upload-imgs pd-img index-pge-uplod">
                                              <label for="edit-img1">
                                                <input class="form-control" id="edit-img1" style="display: none;" type="file" onchange="document.getElementById('fixpic').src = window.URL.createObjectURL(this.files[0])" name="banner_image1" value="">
                                        ...
                                        <div class="form-group col-12 mb-2">
                                            <label class="sr-only" for="complaintinput1">Enter Title</label>
                                            <input type="text" id="banner_title2" class="form-control round" placeholder="Title"  name="banner_title2" value="">
                                        </div>
                                        <div class="form-group col-lg-6 col-xs-12 mb-2">
                                            <div class="upload-imgs pd-img index-pge-uplod">
                                              <label for="edit-img2">
                                                <input class="form-control" id="edit-img2" style="display: none;" type="file" name="banner_image2" value="" onchange="document.getElementById('fixpic1').src = window.URL.createObjectURL(this.files[0])">
                                                <div class="crd-icon diet_title">   
                                                  <h4>Upload Image</h4>                 
                                                  <i class="ft-upload-cloud"></i>
                                                </div>
                                        ...
                                        <div class="form-group col-lg-6 col-xs-12 mb-2">
                                            <div class="upload-imgs pd-img index-pge-uplod bck-image">
                                                <img class="PrintImg" src="" id="fixpic1" style="display: none;" />
                                        ...
                                        <div class="form-group col-12 mb-2">
                                            <label class="sr-only" for="complaintinput1">Enter Title</label>
                                            <input type="text" id="banner_title3" class="form-control round" placeholder="Title" name="banner_title3" value="">
                                        </div>
                                        <div class="form-group col-lg-6 col-xs-12 mb-2">
                                            <div class="upload-imgs pd-img index-pge-uplod">
                                              <label for="edit-img3">
                                                <input class="form-control" id="edit-img3" style="display: none;" type="file" name="banner_image3" value="" onchange="document.getElementById('fixpic2').src = window.URL.createObjectURL(this.files[0])">
                                                <div class="crd-icon diet_title">   
                                                  <h4>Upload Image</h4>                 
                                                  <i class="ft-upload-cloud"></i>
                                                </div>
                                        ...
                                        <div class="form-group col-12 mb-2">
                                            <label class="sr-only" for="complaintinput1">Enter Title</label>
                                            <input type="text" id="banner_title4" class="form-control round" placeholder="Title"  name="banner_title4" value="">
                                        </div>
                                        <div class="form-group col-lg-6 col-xs-12 mb-2">
                                            <div class="upload-imgs pd-img index-pge-uplod">
                                              <label for="edit-img4">
                                                <input class="form-control" id="edit-img4" style="display: none;" type="file" name="banner_image4" value="" onchange="document.getElementById('fixpic3').src = window.URL.createObjectURL(this.files[0])">
                                                <div class="crd-icon diet_title">   
                                                  <h4>Upload Image</h4>                 
                                                  <i class="ft-upload-cloud"></i>
                                                </div>
                                        ...
                                        <div class="form-group col-12 mb-2">
                                            <label class="sr-only" for="complaintinput1">Enter Title</label>
                                            <input type="text" id="banner_title5" class="form-control round" placeholder="Title"  name="banner_title5" value="">
                                        </div>
                                        <div class="form-group col-lg-6 col-xs-12 mb-2">
                                            <div class="upload-imgs pd-img index-pge-uplod">
                                              <label for="edit-img5">
                                                <input class="form-control" id="edit-img5" style="display: none;" type="file" name="banner_image5" value="" onchange="document.getElementById('fixpic4').src = window.URL.createObjectURL(this.files[0])">
                                                <div class="crd-icon diet_title">   
                                                  <h4>Upload Image</h4>                 
                                                  <i class="ft-upload-cloud"></i>
                                                </div>
                        ...
                        <div class="card-body card-header">
                            ...
                            <div class="form_ttle_brdr"></div> 
                                ...
                                <div class="form-body">
                                    <div class="row">                                       
                                        <div class="form-group col-12 mb-2">
                                            <input type="text" id="about_subtitle" class="form-control round" placeholder="Enter Subtitle"  name="about_subtitle" value="">
                                        </div>
                                        <div class="form-group col-12 mb-2">
                                            <input type="text" id="about_title" class="form-control round" placeholder="Enter Title"  name="about_title" value="">
                                        </div>
                                        <div class="form-group col-12 mb-2">
                                            <input type="text" id="about_info_title" class="form-control round" placeholder="Enter Info Title" name="about_info_title" value="">
                                        </div>
                                        <div class="form-group col-12 mb-2">
                                            <textarea id="about_info_description" rows="5" class="form-control round"  placeholder="Enter Info Description" name="about_info_description"></textarea>
                                        </div>
                                        <div class="form-group col-12 mb-2">
                                            ...
                                            <div class="upload-imgs pd-img" id="test">
                                              <label for="edit-img6">
                                                <input onchange="document.getElementById('about_img').src = window.URL.createObjectURL(this.files[0])" class="form-control" id="edit-img6" style="display: none;" type="file" name="about_image" >
                                                <div class="crd-icon diet_title">   
                        ...
                        <div class="card-body card-header">
                            ...
                            <div class="form_ttle_brdr"></div> 
                                ...
                                <div class="form-body">
                                    <div class="row">                                       
                                        <div class="form-group col-12 mb-2">
                                            <input type="text" id="video_title" class="form-control round" placeholder="Enter Title"  name="video_title" value="">
                                        </div>
                                        <div class="form-group col-12 mb-2">
                                            <textarea id="video_description" rows="5" class="form-control round" placeholder="Enter Description" name="video_description"></textarea>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-body card-header">
                            ...
                            <div class="form_ttle_brdr"></div> 
                                ...
                                <div class="form-body">
                                    <div class="row">                                       
                                        <div class="form-group col-12 mb-2">
                                            <input type="text" id="trainer_title" class="form-control round" placeholder="Enter Title" name="trainer_title" value="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-body card-header">
                            ...
                            <div class="form_ttle_brdr"></div> 
                                ...
                                <div class="form-body">
                                    <div class="row">                                       
                                        <div class="form-group col-12 mb-2">
                                            <input type="text" id="video_slider_subtitle" class="form-control round" placeholder="Enter Subtitle"  name="video_slider_subtitle" value="">
                                        </div>
                                        <div class="form-group col-12 mb-2">
                                            <input type="text" id="video_slider_title" class="form-control round" placeholder="Enter Title" name="video_slider_title" value="">
                                        </div>
                                    </div>
                                </div>
