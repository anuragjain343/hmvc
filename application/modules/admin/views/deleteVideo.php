                            ...
                            <div class="card-body">
                                <form class="form" id="" action="" method="POST">
                                    ...
                                    <div class="form-actions frm-btns mt-0">
                                        <a href="javascript:void(0);" class="btn btn-danger mr-1" onclick="deleteReject('<?php echo $videoData->id;?>','<?php echo base_url();?>admin/video/deleteReject')">
                                            <i class="ft-x"></i> Reject
                                        </a>
                                        <a class="btn btn-primary" onclick="deleteVideo('<?php echo $videoData->id;?>','','video/deleteinfoVideo');">
