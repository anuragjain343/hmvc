<div class="app-content content">
	<div class="content-wrapper">
		<div class="content-wrapper-before Hedtxt">
			<h2 class="ml-2">Recipes (<?php echo $total_recepie;?>)</h2>
			<a class="btn btn-sm btn-danger danger box-shadow-3 round btn-min-width pull-right mr-2" href="<?php echo base_url().'admin/recepie/addRecepie'?>">
				<span class="white">Add New</span>
				<i class="ft-book white"></i>
			</a>
		</div>
							...
							<div class="recepie-list transition">
								<div class="media media-res recepie-media">
									...
									<div class="media-body">
										...
										(<?php if($recepie->recepieStatus==0){
...
$.ajax({
url: base_url + 'admin/recepie/recepie_List',
