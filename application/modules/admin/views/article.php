...
<div class="app-content content">
          <div class="content-wrapper">        
            <div class="content-wrapper-before Hedtxt">
                <h2 class="ml-2">Article (<?php if(!empty($total_article)) { echo $total_article;}else{ echo '0';}?>)</h2>
                <a class="btn btn-sm btn-danger danger box-shadow-3 round btn-min-width pull-right mr-2" href="<?php echo base_url();?>admin/article/addArticle">
                    <span class="white">Add New</span>
                    <i class="ft-file-text white"></i>
                </a>
            </div>
                <div class="content-header row mt-10"></div> 
                <div class="row match-height bodySection">
...
<script type="text/javascript">
 ...
 $('#tl_admin_loader').hide();
    ...
    {  var search_val = $('#iconLeft4').val();
        ...
        var dataObject={page:url,csrf_test_name:value,search:search_text};
    $.ajax({
        type:'POST',
        url:url,
        data:dataObject,
...
var  baseurl='<?php echo base_url();?>';
  ...
  // var  url = base_url+'admin/user/loadPagination/0';
    var  url = baseurl+'admin/article/article_list';
    load_page(url);
});
