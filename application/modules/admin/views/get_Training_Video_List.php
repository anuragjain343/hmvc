                                     ...
                                     <div class="videoHidden">
                                        ...
                                        <div style="display:none;" id="video<?php echo $i;?>">
                                            <video class="lg-video-object lg-html5" controls preload="none">
                                                <source src="<?php echo base_url().TRAINING_VIDEO.$value1->trainingVideo?>" type="video/mp4">
                                            </video>
                                        </div>
                                        <?php $i++; } ?>
                                    </div> 
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                                <div class="videoBlock video-blck-box">
                                                    <div class="videoThumb videoResize-md cstm-vedio-thumb blog-pic-wrap">
                                                        ...
                                                        <a data-poster="<?php echo base_url().TRAINING_VIDEO_THUMB.$value->videoThumb;?>" data-sub-html="<?php echo $value->title;?>" data-html="#video<?php echo $j;?>">
                                                    ...
                                                    <i class="ft-trash-2" onclick="deleteVideoByTrainer('<?php echo $value->id; ?>','<?php echo get_csrf_token()['hash'];?>','video/delete_trainingVideo');"></i>
                                                                </a>
                                                            <?php }else{?>
                                                                 <a data-action="javascript:void(0)">          
                                                    <i class="ft-trash-2" onclick="deleteVideoByTrainer('<?php echo $value->id; ?>','<?php echo get_csrf_token()['hash'];?>','video/deleteTrainingVideoByTrainer');"
                                                        ></i>
                                                                </a>
                                                            <?php }?>  
                                                            ...
                                                            <li>
                                                                 <a data-action="" href="<?php echo base_url()?>admin/video/addTrainingVideo/<?php echo encoding($value->id);?>" style="color:#ffffff;">
                                                                    <!--  <a data-action="" > -->
                                                                    <i class="ft-edit-2"></i>
                                                                </a>
                                                            </li>
