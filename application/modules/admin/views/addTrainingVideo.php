                ...
                <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="card-content collpase show">
                            <div class="card-body">
                                <form class="form" id="postVideo" action="<?php echo base_url();?>admin/video/add_tainingVideo" method="POST" autocomplete="off">
                                    <div class="form-body">
                                        ...
                                        <div class="row">                                       
                                         ...
                                         <div class="form-group col-12 mb-2">
                                                <div class="upload-imgs pd-img">
                                                  <label for="edit-img">
                                                <input class="form-control" name="trainingVideo"  id="edit-img" style="display: none;" type="file"  accept="video/mp4"> 
                                    ...
                                    <div class="form-actions border-0 frm-btns mt-0">
                                        ...
                                        <a class="btn btn-primary" id="post_training_Video">
