...
<div class="app-content content">
	<div class="content-wrapper">
			...
			<div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
				<div class="card">
					...
					<div class="card-content collpase show">
						<div class="card-body">
							<form class="form" id="add_Recepie" action="<?php echo base_url()?>admin/recepie/add_recepie" autocomplete="off">
								<div class="form-body">
									<div class="row"> 
										...
										<div class="form-group col-12 mb-2">
											...
											<input type="text" id="complaintinput1" class="form-control round autoSaveElement" placeholder="Title" name="title" moduleType="recepie">
										</div>
										<div class="form-group col-12 mb-2">
										...
										<div class="form-group col-12 mb-2">
											...
											<textarea id="complaintinput5" rows="5" class="form-control round autoSaveElement" name="description" placeholder="Description" moduleType="recepie"></textarea>
										</div>
		...
		<p style="color: gray;font-size: 11px; position: relative;left: 17px;">Image should be at least 300*300px</p>
										<div class="form-group col-12 mb-2">
