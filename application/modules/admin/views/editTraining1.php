                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6 mb-2">
                                            <div class="upload-imgs pd-img index-pge-uplod bck-image">
                                                <img class="PrintImg" src="<?php echo base_url(TRAINING_THUMB).$image1;?>" id="preview1" style="<?php echo $style1;?>">
                                        ...
                                        <div class="form-group col-6 mb-2">
                                            <div class="upload-imgs pd-img index-pge-uplod bck-image">
                                                <img class="PrintImg" src="<?php echo base_url(TRAINING_THUMB).$image2;?>" id="preview2" style="<?php echo $style2;?>">
                                        ...
                                        <div class="form-group col-6 mb-2">
                                            <div class="upload-imgs pd-img index-pge-uplod bck-image">
                                                <img class="PrintImg" src="<?php echo base_url(TRAINING_THUMB).$image3;?>" id="preview3" style="<?php echo $style3;?>">
                                        ...
                                        <div class="form-group col-6 mb-2">
                                            <div class="upload-imgs pd-img index-pge-uplod bck-image">
                                                <img class="PrintImg" src="<?php echo base_url(TRAINING_THUMB).$image4;?>" id="preview4" style="<?php echo $style4;?>">
                                        ...
                                        <div class="form-group col-6 mb-2">
                                            <div class="upload-imgs pd-img index-pge-uplod bck-image">
                                                <img class="PrintImg" src="<?php echo base_url(TRAINING_THUMB).$image5;?>" id="preview5" style="<?php echo $style5;?>">
                                    ...
                                    <p class="col-12 ttle-baner">Video 1</p>
                                          <div class="form-group col-12 mb-2" id="far">
                                                <div class="icon-crd">
                                                 ...
                                                 <video style="width: 100%; height: 281px; background-color: rgb(0, 0, 0); border: 1px solid rgba(238, 255, 238, 0.933); <?php echo $stylev1;?>" id="showVideo1" controls=""><source  id="video_here1" src="<?php echo base_url(TRAINING_CATEGORY_VIDEO).$video1;?>"></video> 
                                    ...
                                    <p class="col-12 ttle-baner">Video 2</p>
                                      <div class="form-group col-12 mb-2">
                                                <div class="icon-crd">
                                                 ...
                                                 <video style="width: 100%; height: 281px; background-color: rgb(0, 0, 0); border: 1px solid rgba(238, 255, 238, 0.933); <?php echo $stylev2;?>" id="showVideo2" controls=""><source  id="video_here2" src="<?php echo base_url(TRAINING_CATEGORY_VIDEO).$video2;?>"></video> 
                                    ...
                                    <p class="col-12 ttle-baner">Video 3</p>
                                      <div class="form-group col-12 mb-2">
                                                <div class="icon-crd">
                                                 ...
                                                 <video style="width: 100%; height: 281px; background-color: rgb(0, 0, 0); border: 1px solid rgba(238, 255, 238, 0.933); <?php echo $stylev3;?>" id="showVideo3" controls="" ><source  id="video_here3" src="<?php echo base_url(TRAINING_CATEGORY_VIDEO).$video3;?>"></video>
                                    ...
                                    <p class="col-12 ttle-baner">Video 4</p>
                                     <div class="form-group col-12 mb-2">
                                                <div class="icon-crd">
                                                 ...
                                                 <video style="width: 100%; height: 281px; background-color: rgb(0, 0, 0); border: 1px solid rgba(238, 255, 238, 0.933); <?php echo $stylev4;?>" id="showVideo4" controls="" ><source  id="video_here4" src="<?php echo base_url(TRAINING_CATEGORY_VIDEO).$video4;?>"></video> 
                                    ...
                                    <p class="col-12 ttle-baner">Video 5</p>
                                       <div class="form-group col-12 mb-2">
                                                <div class="icon-crd">
                                                 ...
                                                 <video style="width: 100%; height: 281px; background-color: rgb(0, 0, 0); border: 1px solid rgba(238, 255, 238, 0.933); <?php echo $stylev5;?>" id="showVideo5" controls=""><source  id="video_here5" src="<?php echo base_url(TRAINING_CATEGORY_VIDEO).$video5;?>"></video> 
