                                               ...
                                               if(!empty($value1)){ 
                                                ?>
                                                    <div class="item imgSlide">
                                                        <a class="pic" data-src="<?php echo base_url(RECOMMENDEDPRODUCTS_MEDIUM).$value1;?>"><img src="<?php echo base_url(RECOMMENDEDPRODUCTS_MEDIUM).$value1;?>" /></a>
                                                    </div>
                                              <?php } }?>
                        ...
                        <div class="recipeInfo">                        
                            <div class="prdct-value-info">
                                ...
                                <div class="recipesDes"  id="show<?php echo $value->id;?>" style="display:none;" style="float:left;">
                                    <p class="paraText"><?php echo $value->description;?></p>
                                    <p id="less<?php echo $value->id;?>"onclick="f2('<?php echo $value->id;?>')" style="color: #43a4dc; cursor: pointer; position: relative;">...Read less</p>
                                </div>
                                    ...
                                    <div class="videoHidden">
                                        ...
                                        <div style="display:none;" id="video<?php echo $i;?>">
                                            ...
                                            <video class="lg-video-object lg-html5" controls preload="none">
                                                <source src="<?php echo base_url().RECOMMENDEDPRODUCTS_VIDEO.$valuevideo;?>" type="video/mp4">
                                            </video>
                                        <?php }?>
                                        </div>
                                    <?php $i++; } ?>
                                                            ...
                                                            <div class="item">
                                                                <div class="videoBlock cstm-vdio-block video-blck-box mb-0">
                                                                    <div class="videoThumb videoResize-sm cstm-vedio-thumb blog-pic-wrap">
                                                                        <a href="" data-poster="<?php echo base_url().RECOMMENDEDPRODUCTS_VIDEO_THUMB.$valuevideoT;?>" data-sub-html="Full Body Workout In The Gym" data-html="#video<?php echo $i;?>">
                                                                          <img class="" src="<?php echo base_url().RECOMMENDEDPRODUCTS_VIDEO_THUMB.$valuevideoT;?>">
