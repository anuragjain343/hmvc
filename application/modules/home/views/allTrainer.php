                            ...
                            <div class="pricing-table trainr-slidr-table clr-chnge mb-30">
                              <div class="col-sm-12 planInfo clr-back">
                                ...
                                <span class="recipesDes"  id="show<?php echo $key;?>" style="display:none;" style="float:left;">
                                    ...
                                    <span id="less<?php echo $key;?>" class="readLess" data-key="<?php echo $key;?>" style="color: #43a4dc; cursor: pointer;">...Read less</span>
                                </span>
                                <span class="recipesDes"  id="hide<?php echo $key;?>">
                                    ...
                                    <span id="more<?php echo $key;?>" class="readMore" data-key="<?php echo $key;?>"  style="color: #43a4dc; cursor: pointer; position: relative;">Read more</span>
                                   <?php }?>
                                </span>
                                  </ul> 
                              ...
                              <?php }else{?>
                                  <a class="btn btn-theme btn-bg-t btn-round rgt-btn"  onclick="isRegister('<?php echo base_url();?>home/users/payment?level=<?php echo $selectlevel; ?>&trainer=<?php echo encoding($value->trainerId);?>&price=<?php echo encoding($value->priceOther);?>&stripPlanId=<?php echo $value->stripPlanId;?>&commisitionTrainer=<?php echo encoding($commisitionTrainer);?>&couponsId=<?php echo encoding($value->coupan);?>&discountData=<?php echo encoding($value->discountData);?>&duration=<?php echo encoding($value->duration);?>','');">
                              Continue</a>
...
$(document).on('click','.readMore',function(){
    let key = $(this).data('key');
     ...
     console.log($(this).parent().parent().parent().parent().parent().prev().html());
