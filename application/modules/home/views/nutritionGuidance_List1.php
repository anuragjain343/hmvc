                                               ...
                                               if(!empty($value1)){ 
                                                ?>
                                                    <div class="item imgSlide">
                                                        <a class="pic" data-src="<?php echo base_url(NURRITIONGUIDANCE_MEDIUM).$value1;?>"><img src="<?php echo base_url(NURRITIONGUIDANCE_MEDIUM).$value1;?>" /></a>
                                                    </div>
                                              <?php } }?>
...
<!--                                 <div class="recipesDes">
                                    ...
                                    <p class="paraText"><?php echo $value->description;?></p>
                                    <p id="less<?php echo $value->id;?>"onclick="f2('<?php echo $value->id;?>')" style="color: #43a4dc; cursor: pointer;">...Read less</p>
                                </div>
                                
                                <div class="recipesDes"  id="hide<?php echo $value->id;?>">

                                    <span class="paraText" ><?php custom_echo ($value->description,250);?></span>
                                    
                                    <?php if(strlen($value->description)>250){?>
                                    <span id="more<?php echo $value->id;?>"onclick="f1('<?php echo $value->id;?>')" style="color: #43a4dc; cursor: pointer; position: relative;">Read more</span>
                            <?php }?>
                                </div>
                            ...
                            <?php }?>
                                ...
                                <section class="video-sec">
                                    <div class="videoHidden">
                                        ...
                                        <div style="display:none;" id="video<?php echo $i.'-'.$k;?>">
                                            <?php if(!empty($valuevideo)){?>
                                            <video class="lg-video-object lg-html5" controls preload="none">
                                                <source src="<?php echo base_url().NURRITIONGUIDANCE_VIDEO.$valuevideo;?>" type="video/mp4">
                                            </video> 
                                        <?php }?>
                                        </div>
                                    <?php $i++; } ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-lg-12">
                                                        <div id="videoSlide3" class="owl-carousel owl-theme csSlider">
                                                            <?php $i=1; foreach($videoThumb as $key => $valuevideoT){ 
                                                            ...
                                                            <div class="item">
                                                                <div class="videoBlock cstm-vdio-block video-blck-box mb-0">
                                                                    ...
                                                                    <div class="videoThumb videoResize-sm cstm-vedio-thumb blog-pic-wrap">
                                                                        <a href="" data-poster="<?php echo base_url().NURRITIONGUIDANCE_VIDEO_THUMB.$valuevideoT;?>" data-sub-html="<?php echo $value->title;?>" data-html="#video<?php echo $i.'-'.$k;?>">
                                                                          <img class="" src="<?php echo base_url().NURRITIONGUIDANCE_VIDEO_THUMB.$valuevideoT;?>">
