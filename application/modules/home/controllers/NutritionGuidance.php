...
class NutritionGuidance extends Common_Front_Controller {
  ...
  $data['front_styles']= array('frontend_assets/css/lightgallery.min.css','frontend_assets/js/toastr/toastr.min.css','frontend_assets/custom/css/front_custom.css');
    ...
    $data['title'] = 'NutritionGuidance Details';
    $data['catid']=  $cate;
    $this->load->front_render('NutritionGuidanceDetails',$data,'');
    ...
    function nutritionGuidanceDetail(){
       ...
       // pr($offset);
        ...
        $dataView['total_count']      = $this->NutritionGuidance_model->nutritionGuidanceCount($where);
        //pr($dataView['total_count']);
        $whereart              = array('categoryId'=>$articleid);
        $dataView['nutritionGuidanceData'] = $this->NutritionGuidance_model->getNutritionGuidanceAll($limit,$offset,$whereart);
        ...
        //load view with data
        $html_view = $this->load->view('nutritionGuidance_List',$dataView,true);
