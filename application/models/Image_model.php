...
class Image_model extends CI_Model{
    ...
    function image_sizes($folder){
        ...
        switch($folder){
            ...
            case 'Training' :       
            $img_sizes['thumbnail'] = array('width'=>300, 'height'=>300, 'folder'=>'/thumb');       
            $img_sizes['medium'] = array('width'=>504, 'height'=>366, 'folder'=>'/medium');     
            break;      
            ...
            case 'Training_video_thumb' :       
           /*$img_sizes['thumbnail'] = array('width'=>370, 'height'=>278, 'folder'=>'/thumb'); */      
           $img_sizes['thumbnail'] = array('width'=>300, 'height'=>300, 'folder'=>'/thumb');       
            $img_sizes['medium'] = array('width'=>540, 'height'=>600, 'folder'=>'/medium');     
            break;    

            	case 'RecommendedProducts_video_thumb':       		
	            $img_sizes['thumbnail'] = array('width'=>300, 'height'=>300, 'folder'=>'/thumb');        		
	            $img_sizes['medium'] = array('width'=>540, 'height'=>600, 'folder'=>'/medium');     		
	            break;		
            ...
            case 'banner' :
                $img_sizes['large'] = array('width'=>1380, 'height'=>590, 'folder'=>'/large');
                $img_sizes['medium'] = array('width'=>1280, 'height'=>548, 'folder'=>'/medium');
                break;

                case 'about' :
                $img_sizes['medium'] = array('width'=>400, 'height'=>409, 'folder'=>'/medium');
                $img_sizes['thumbnail'] = array('width'=>350, 'height'=>358, 'folder'=>'/thumb');
                break;
            ...
            case 'video_recepie' :
                $img_sizes['thumbnail'] = array('width'=>370, 'height'=>278, 'folder'=>'/thumb');
                $img_sizes['medium'] = array('width'=>640, 'height'=>360, 'folder'=>'/medium');
            break; 
            case 'recepie_video_thumb' :
                 $img_sizes['thumbnail'] = array('width'=>300, 'height'=>300, 'folder'=>'/thumb');  
                $img_sizes['medium'] = array('width'=>640, 'height'=>360, 'folder'=>'/medium');
            break;
            ...
            case 'NutritionGuidanceVideo_thumb' :
                $img_sizes['thumbnail'] = array('width'=>300, 'height'=>300, 'folder'=>'/thumb');  
                $img_sizes['medium'] = array('width'=>504, 'height'=>366, 'folder'=>'/medium');
            break;
    ...
    function upload_image($image, $folder, $height=768, $width=1024, $path=FALSE ){
        ...
        if($folder=='banner'){
            $min_width = $img_sizes_arr['large']['width'];
            $min_height = $img_sizes_arr['large']['height'];
        }else{
